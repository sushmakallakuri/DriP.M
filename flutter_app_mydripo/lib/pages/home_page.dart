                       ...
                       Container(
                         ...
                         child: Column(
                           children: <Widget>[
                             ...
                             Padding(
                               padding: EdgeInsets.all(3.0),
                               child: new Text("Patient Name : "+name,
                                 style: TextStyle(
                             ...
                             Padding(
                               padding:  EdgeInsets.all(3.0),
                               child: new Text("Volume : "+Vol.toString(),
                                 style: TextStyle(
                                   fontWeight: FontWeight.w300,
                                   fontSize: 15,
                                 ),
                             ...
                             Padding(
                               padding:  EdgeInsets.all(3.0),
                               child: new Text("Estimate TIme : "+estime.toString(),
                                 style: TextStyle(
                                   fontWeight: FontWeight.w300,
                                   fontSize: 15,
                                 ),
                          ...
                          child: ButtonBar(
                            children: <Widget>[
                              ...
                              FlatButton(
                                ...
                                child: const Text('10ml/hr'),
                                onPressed: () {
                                  Colors.green;
                                  _database.reference().child("patients").child(roomno).update({'speed':'10'}) ;},
                              ),
                              FlatButton(
                                textColor: Colors.black54,
                                child: const Text('20ml/hr'),

                                onPressed: () {
                                  /* ... */
                                  Colors.green;
                                  _database.reference().child("patients").child(roomno).update({'speed':'20'}) ;},
                              ),
                              FlatButton(
                                textColor: Colors.black54,
                                child: const Text('30ml/hr'),
                                onPressed: () {
                                  Colors.green;
                                  _database.reference().child("patients").child(roomno).update({'speed':'30'}) ; },
                              ),
                            ],
                          ),
                        ), */
